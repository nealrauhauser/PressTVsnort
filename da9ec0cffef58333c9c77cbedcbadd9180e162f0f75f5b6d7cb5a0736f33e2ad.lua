...
z_file_policy =
{
  -- { when = { file_type_id = 273 }, use = { verdict = 'block'} },
  -- { when = { sha256 = "E038B5168D9209267058112D845341CAE83D92B1D1AF0A10B66830ACB7529494" }, use = { verdict = 'block'} }
}
file_id =
{
  enable_type = true,
